...
def main():
    ...
    sparse_matrix = io.mmread('/Users/matthewthompson/Documents/UAMS_SURF/K-mer_testing/CSV_files/10_genome_4mer_counts_sparse/4mer_top_5_table_full_alphabet_compressed')
    #df = pd.DataFrame(sparse_matrix.toarray()) 
    print("Converting to csr_matrix")
    df = sparse.csr_matrix(sparse_matrix)
    
    '''
    kmers = pd.read_csv('/Users/matthewthompson/Documents/UAMS_SURF/K-mer_testing/CSV_files/10_genome_4mer_counts_sparse/top_5_kmers.csv')
    ...
    proteins = pd.read_csv('/Users/matthewthompson/Documents/UAMS_SURF/K-mer_testing/CSV_files/10_genome_4mer_counts_sparse/top_5_protein_list.csv')
    ...
    with open('/Users/matthewthompson/Documents/UAMS_SURF/K-mer_testing/CSV_files/10_genome_top_5_4mer_full_alphabet_cosine_clusters_0.5_ps.csv', 'w') as csv_file:
        writer = csv.writer(csv_file)
        for key, value in canopies.items():
            writer.writerow([key, value])
    
    with open('/Users/matthewthompson/Documents/UAMS_SURF/K-mer_testing/CSV_files/10_genome_top_5_4mer_full_alphabet_cosine_grouping_list_0.5_ps.csv', 'w') as csv_file:
        writer = csv.writer(csv_file)

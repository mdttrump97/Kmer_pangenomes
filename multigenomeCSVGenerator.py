...
kmer_list = pd.read_csv("/Users/matthewthompson/Documents/UAMS_SURF/K-mer_testing/CSV_files/4mer_counts_sparse/4mer_list.csv")
del kmer_list["Unnamed: 0"]
kmer_list = kmer_list["x"]
kmer_dict = dict(zip(list(range(0, len(kmer_list))), list(kmer_list)))

data_folder = '/Users/matthewthompson/Documents/UAMS_SURF/K-mer_testing/CSV_files/20_genomes/'
...
for x in range(20):
    ...
    protein_list = pd.read_csv(file.split("_4mer_count_")[0] + "_protein_list.csv")
...
io.mmwrite('/Users/matthewthompson/Documents/UAMS_SURF/K-mer_testing/CSV_files/20_genomes/20_genome_4mer_top_5_all_FYWH_CM.mtx', top_x_coo)
with open('/Users/matthewthompson/Documents/UAMS_SURF/K-mer_testing/CSV_files/20_genomes/20_genome_4mer_top_5_all_FYWH_CM_kmers.csv', 'w') as writeFile:
    writer = csv.writer(writeFile)
    writer.writerow(top_x_df.index)
with open('/Users/matthewthompson/Documents/UAMS_SURF/K-mer_testing/CSV_files/20_genomes/20_genome_4mer_top_5_all_FYWH_CM_protein_list.csv', 'w') as writeFile:
    writer = csv.writer(writeFile)
